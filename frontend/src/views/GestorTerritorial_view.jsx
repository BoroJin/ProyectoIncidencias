...
const GestorTerritorialView = () => {
            ...
            title="Mapa">
              <div id="map"></div>
                    <div id="buttons" style={{ display: 'none' }}>
                      <button id="removeMarker" className="custom-button1">Remover marcador</button>
                      <button id="openPopup" className="custom-button2">Rellenar formulario</button>
                    </div>
            </Card>
  ...
  export default GestorTerritorialView; 
