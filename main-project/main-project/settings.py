"""
Django settings for main-project project.
...
SECRET_KEY = 'django-insecure-^clc#p7_r6(9#^j+fm0papu_*@4i9o@&1up23%)9fia)%a3(1!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'administrador.context_processors.logo_context', 
            ],
        },
    },
]
...
# Si usas una carpeta global para recolectar los archivos estáticos
