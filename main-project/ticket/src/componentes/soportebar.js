  ...
  return (
    <div className="soportebar">
      <div className="logo-container">
        <img src={`http://localhost:8000${config.imagen}`} alt="MuniLogo" className="logo" />
      </div>
      ...
      <ul className="sidebar-menu">
        ...
        <li className="sidebar-item">
          <Link className="textItem" to="/Aplicacion">
            <IoHomeSharp />
            <p className="textoS">Sobre la aplicación</p>
          </Link>
        </li>
        <li className="sidebar-item">
        ...
        <li className="sidebar-item">
          <Link className="textItem" to="/documentacion">
            <IoDocuments /> <p className="textoS">Documentación</p>
          </Link>
        </li>
        <li className="sidebar-item">
